# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_names.ipynb.

# %% auto 0
__all__ = ['rally', 'players', 'game', 'team', 'match', 'tournament', 'get_team_name', 'get_player_name', 'get_player_id']

# %% ../nbs/04_names.ipynb 3
from .data import *
from .stats import *
import pandas as pd


# %% ../nbs/04_names.ipynb 4
